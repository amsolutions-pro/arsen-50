    ...
    categories: [
      {
        ...
        title: 'ՆԱԽՈՒՏԵՍՏՆԵՐ',
        items: [
          'Տան հատուկ մսային ասսորտի',
          'Ձկան ասսորտի',
          'Հայկական ձկան ասսորտի',
          'Ղավուրմա',
          'Գյուղական պանրի ասսորտի',
          'Գինու համար պանրի ասսորտի',
          'Բանջարեղենային աղաջք',
          'Բանջարեղենային ասսորտի',
          'Հումուս սմբուկով',
          'Ընկույզի մածուկ',
          'Թարմ կանաչի',
          'Տնական թթու բանջարեղեն',
          'Քամած մածուն',
          'Ռեժան',
          'Ձիթապտուղ',
          'Կիտրոն',
