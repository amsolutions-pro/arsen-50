    ...
    categories: [
      {
        ...
        items: [
          ...
          'Փղփեղանի',
          'Խրթխրթան աղցան',
          'Թարխուն և հողում պահված պանիր (սեզոնային)',
          'Հավ և կինոա',
          'Տավար և սմբուկ',
          'Ավելուկ',
      ...
      },
      {
        ...
        items: [
          ...
          'Թավա սուլուգունի',
          'Թավա կոտլետ պանրով',
          'Խորոված երշիկների տեսականի',
          'Արիշտա ճակնդեղի տերևով',
          'Կյուֆթա սերուցքային սոուսով',
          'Խուրջին',
          'Խուրջին գառան մսով',
          'Կալագյոշ',
          'Տավարի խաշլամա',
          'Գառան խաշլամա',
          'Երևանյան թափաքա արենի',
          'Սյունիք խաշնթուր',
          'Եղեգնաձորի լցոնված խոզի կողիկ',
          'Նազելի',
          ...
          'Խոզի բեկոն',
          'Իշխանի ֆիլե',
          'Գառան կողիկ աշտարակ սոուսով',
          'Բանջարեղենային',
          'Խորոված խոզի կողիկ',
          'Խորոված խոզի կողոսկր',
          'Խորոված խոզի ֆիլե',
          'Խորոված տավարի ֆիլե',
          'Խորոված գառան կողիկ',
          'Խորոված գառան ֆիլե',
          'Խորոված գառան կողոսկր',
          'Խորոված հավ',
          'Տավարի քյաբաբ',
          'Հավի քյաբաբ',
          'Գառան քյաբաբ',
          'Որսորդական քյաբաբ',
          'Խորոված բանջարեղեն շամփուրով',
          'Խորոված կարտոֆիլ շամփուրով',
          'Խորոված սունկ շամփուրով',
          'Խորոված կծու պղպեղ',
          'Խորոված սոխ',
          'Եփած իշխան',
          'Խորոված իշխան',
      ...
      },
      {
        ...
        items: [
          ...
          'Խորոված բանջարեղեն',
          'Փլավ բրնձով և բանջարեղենով',
          'Փլավ սպելտայով և սնկով',
          'Արիշտա',
          'Տապակած սպանախ',
          'Տապակած ճակնդեղի տերևներ',
          'Կարտոֆիլի պյուրե',
          'Բրինձ'
        ]
      }
